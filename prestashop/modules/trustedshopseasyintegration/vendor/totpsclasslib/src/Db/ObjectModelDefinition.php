...
class ObjectModelDefinition
{
    ...
    /**
     * @var array of TrustedshopsClasslib\Db\DbTableDefinitionRelation
     */
    protected $relations;
    ...
    /**
     * @param string $id
     * @return TrustedshopsClasslib\Db\DbSchema
     */
    ...
    /**
     * @param string $id
     * @return TrustedshopsClasslib\Db\DbTableDefinitionRelation
     */

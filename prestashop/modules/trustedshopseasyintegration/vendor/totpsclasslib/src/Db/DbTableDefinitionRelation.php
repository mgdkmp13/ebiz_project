...
class DbTableDefinitionRelation
{
    ...
    /**
     * @var trustedshopsObjectModelDefinition
     */
    protected $def;

    /**
     * Register trustedshopsObjectModelDefinition and the internal ID
     * @param trustedshopsObjectModelDefinition $def
     * @param string                $id
     */
    ...
    /**
     * Get key value from trustedshopsObjectModel::$definition['associations'][$this->id]
     * @param string $key
     * @return array|null
     */

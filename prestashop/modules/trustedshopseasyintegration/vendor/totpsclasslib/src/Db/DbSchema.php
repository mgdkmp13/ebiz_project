...
{
    /**
     * @var TrustedshopsClasslib\Db\ObjectModelDefinition
     */
    protected $def;
    ...
    /**
     * Register TrustedshopsClasslib\Db\ObjectModelDefinition and table (internal) ID
     * @param TrustedshopsClasslib\Db\ObjectModelDefinition $def
     * @param string                $id
     */
     ...
     * @param TrustedshopsClasslib\Db\DbTable $table
     * @return TrustedshopsClasslib\Db\DbTable
     */

...
<script src="{$eventsUrl|escape:'htmlall':'UTF-8'}"></script>
<script src="{$connectorUrl|escape:'htmlall':'UTF-8'}"></script>
<script src="{$clientAdminJs|escape:'htmlall':'UTF-8'}"></script>
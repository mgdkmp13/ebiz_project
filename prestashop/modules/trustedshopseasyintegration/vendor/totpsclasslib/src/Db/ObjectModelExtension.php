...
namespace TrustedshopsClasslib\Db;

use TrustedshopsClasslib\Db\ObjectModelDefinition;
use TrustedshopsClasslib\Db\DbTableDefinitionModel;
use TrustedshopsClasslib\Db\DbTableDefinitionRelation;
use TrustedshopsClasslib\Db\DbSchema;
use TrustedshopsClasslib\Db\DbTable;
...
class ObjectModelExtension
{
    ...
    /**
     * @return TrustedshopsClasslib\Db\ObjectModelDefinition (as an array collection object)
     */
    ...
    /**
     * @param TrustedshopsClasslib\Db\DbSchema $schema
     * @return bool
     */

...
namespace TrustedshopsClasslib\Install;
...
use \Tab;
use \Tools;
use TrustedshopsClasslib\Db\ObjectModelExtension;
...
abstract class AbstractInstaller
{
    ...
    public function installAdminControllers()
    {
        ...
        foreach ($this->getAdminControllers() as $tabData) {
            ...
            if ($tabData['class_name'] == 'trustedshopseasyintegration' && version_compare(_PS_VERSION_, '1.7', '<')) {
